...
pub(crate) const IPV6_DEFAULT_HOP_LIMIT: u8 = 64;

#[allow(dead_code)]
pub(crate) fn build_ipv6_packet(ipv6_packet: &mut MutableIpv6Packet<'_>, src_ip: Ipv6Addr, dst_ip: Ipv6Addr, next_protocol: IpNextHeaderProtocol) {
